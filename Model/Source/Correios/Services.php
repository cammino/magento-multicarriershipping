<?php
class Cammino_Multicarriershipping_Model_Source_Correios_Services
{
    public function toOptionArray()
    {

    	$confUser = Mage::getStoreConfig('carriers/webservicecorreios/user');
    	$confPass = Mage::getStoreConfig('carriers/webservicecorreios/pass');
    	$services = null;
